...
const AddProduct = () => {
    ...
    const Add_Product = async () =>{
        ...
        await fetch('https://branding-displays.onrender.com/upload',{
            method: 'POST',
            headers:{
        ...
        if(responseData.success){
            ...
            console.log(product)
            await fetch('https://branding-displays.onrender.com/addproduct',{
                method: 'POST',
                headers:{
                    Accept: 'application/json',
  ...
  return (
    <div className='p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7'>
        ...
        <div className='mb-3 flex items-center gap-x-4'>
            <h4 className='bold-18 pb-2'>Select Page:</h4>
